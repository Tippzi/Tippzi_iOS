...
open class SearchTextField: UITextField {
    ...
    open func addBars(_ strings: [String]) {
        var items = [SearchTextFieldItem]()
        
        for value in strings {
            items.append(SearchTextFieldItem(title: value, image:UIImage(named: "icon_bar.png")))
        }
        
        filterItems(items)
    }
    open func addServices(_ strings: [String]) {
        var items = [SearchTextFieldItem]()
        
        for value in strings {
            items.append(SearchTextFieldItem(title: value, image:UIImage(named: "icon_service.png")))
        }
        
        filterDataSource.append(contentsOf: items)
//        filterItems(items)
    }

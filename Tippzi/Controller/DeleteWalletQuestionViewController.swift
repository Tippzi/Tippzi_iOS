//
//  DeleteWalletQuestionViewController.swift
//  Tippzi
//
...
class DeleteWalletQuestionViewController: UIViewController {
    ...
    @IBAction func btnYesClick(_ sender: Any) {
        ...
        Delete_Deal(Common.inWallet_delete_index)
        
    }
    
    @IBAction func btnNoClick(_ sender: Any) {
        
        Common.inWallet_delete_index = 0
    ...
    func Delete_Deal(_ delete_pos: Int) {
        ...
        let deal_id = Common.customerModel.wallets[delete_pos].deal_id
        let bar_id = Common.customerModel.wallets[delete_pos].bar_id
        
        //create the url with URL
        let url = URL(string:Common.api_location + "delete_wallet.php")!
        
        let params = ["user_id": user_id, "deal_id": deal_id, "bar_id": bar_id, "lat": latitude, "lon": longitude] as [String : Any]

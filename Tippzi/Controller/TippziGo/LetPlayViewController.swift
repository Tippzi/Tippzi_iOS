...
class LetPlayViewController: UIViewController {
...
//        self.playButton.setTitleColor(UIColor.black, for: UIControlState.highlighted)
    ...
    @IBAction func playAction(_ sender: Any) {
        let toViewController = self.storyboard?.instantiateViewController(withIdentifier: "CollectedViewController")
        self.navigationController?.pushViewController(toViewController!, animated: true)
    }
    
    @IBAction func playDownAction(_ sender: Any) {
//        self.playButton.backgroundColor = UIColor.white
    }
    
    @IBAction func playUpAction(_ sender: Any) {
//        self.playButton.backgroundColor = UIColor.clear
    }
}
